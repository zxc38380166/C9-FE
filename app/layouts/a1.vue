    ...
    <UDashboardPanel :ui="{ body: 'bg-slate-800 !px-0 !pb-0 !pt-8' }">
        ...
        <UDashboardNavbar
          ...
          <template #right>
            <div v-if="isLogin" class="flex items-center gap-1.5 sm:gap-2.5">
              <!-- 餘額卡片 -->
              <div
                class="flex items-center gap-1.5 sm:gap-2 rounded-full bg-white/5 ring-1 ring-white/10 pl-2.5 sm:pl-3 pr-1 sm:pr-1.5 py-1 sm:py-1.5">
              ...
              <UDropdownMenu
                ...
                :ui="{
                  content:
                    'z-50 bg-[#131f30] ring-1 ring-white/10 shadow-[0_16px_48px_-8px_rgba(0,0,0,0.6)] rounded-xl overflow-hidden data-[state=open]:animate-[scale-in_100ms_ease-out] data-[state=closed]:animate-[scale-out_100ms_ease-in]',
                  viewport:
                    'w-[260px] sm:w-[280px] divide-y divide-white/6 scroll-py-1 overflow-y-auto scrollbar-hide flex-1',
                  group: 'p-1.5 isolate',
                  ...
                  itemLeadingIcon:
                    'shrink-0 size-4 text-white/40 group-data-highlighted:text-emerald-400',
                  itemWrapper: 'flex-1 flex flex-col text-start min-w-0',
                  itemLabel: 'truncate text-[13px] font-medium p-1.5',
                  itemTrailingKbds: 'hidden lg:inline-flex items-center shrink-0',
                }">
                <button
                  class="relative flex items-center gap-2 rounded-full bg-white/5 ring-1 ring-white/10 hover:bg-white/8 p-1 sm:pl-3 sm:pr-2 sm:py-1.5 transition-colors cursor-pointer">
                  <span
                    class="hidden sm:inline text-[13px] font-semibold text-white/80 max-w-20 truncate">
                  ...
                  <div class="relative">
                    ...
                    <div
                      class="absolute -bottom-0.5 -right-0.5 size-2.5 sm:size-3 rounded-full bg-emerald-400 ring-2 ring-slate-900" />
                  </div>
                </button>
              </UDropdownMenu>
            </div>
      ...
      <template #body>
        <div>
          ...
          <div class="bg-slate-900 pb-16 lg:pb-0">
            <A1LayoutFooter />
          </div>
          <A1LayoutBottomBar />
        </div>
