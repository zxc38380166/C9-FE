    ...
    <div class="pb-100">
      <UAccordion
        ...
        :ui="{
          ...
          header: 'w-full',
          trigger:
            'group w-full flex items-center justify-between gap-4 px-5 py-4 text-left ' +
            'hover:bg-white/[0.04] transition-colors',
          title: 'text-[15px] md:text-base font-semibold text-white/90 group-hover:text-white',
