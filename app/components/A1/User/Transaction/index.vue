<template>
  <div
    ...
    <div class="flex items-center gap-2.5 sm:gap-3">
      <div
        class="size-8 sm:size-10 rounded-[10px] sm:rounded-[12px] bg-linear-to-br from-emerald-500/20 to-emerald-700/10 ring-1 ring-emerald-500/30 flex items-center justify-center">
    ...
    <!-- Tab 導航 -->
    <div
      class="flex gap-1.5 sm:gap-2 rounded-[10px] sm:rounded-[12px] bg-white/4 ring-1 ring-white/6 p-1 sm:p-1.5">
      <button
        v-for="tab in tabs"
        :key="tab.value"
