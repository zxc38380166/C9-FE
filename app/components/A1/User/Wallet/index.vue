<template>
  <div class="rounded-[16px] bg-[#131f30] ring-1 ring-white/8 p-5 space-y-5">
    ...
    <div class="flex items-center gap-3">
      <div class="size-10 rounded-[12px] bg-linear-to-br from-blue-500/20 to-blue-700/10 ring-1 ring-blue-500/30 flex items-center justify-center">
        <UIcon name="i-lucide-wallet" class="size-5 text-blue-400" />
      </div>
      <div>
        <div class="text-[22px] font-bold text-white tracking-wide">帳戶錢包管理</div>
        <div class="text-[12px] text-white/40">管理您的銀行卡、信用卡與加密貨幣錢包</div>
      </div>
    </div>
