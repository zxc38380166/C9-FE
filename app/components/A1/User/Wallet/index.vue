<template>
  <div
    ...
    <div class="flex items-center gap-2.5 sm:gap-3">
      <div
        class="size-8 sm:size-10 rounded-[10px] sm:rounded-[12px] bg-linear-to-br from-blue-500/20 to-blue-700/10 ring-1 ring-blue-500/30 flex items-center justify-center">
